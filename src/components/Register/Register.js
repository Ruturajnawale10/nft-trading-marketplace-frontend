  ...
  render() {
    ...
    <div>
        ...
        <div class="container" style={{width:"40%"}}>
            <br />
        <div>
            <h1 style={{textAlign: "center"}}>Join the most trusted NFT Trading Marketplace</h1>
        </div>
        <br/>
            ...
            <Form.Group className="mb-3" controlId="formNickname">
              ...
              <Form.Control type="text" placeholder="Enter Nickname" name="nickname" value={this.state.nickname} onChange={this.handleChange}  autoFocus/>
            </Form.Group>
            <br/>
